      ...
      <main>
        ...
        <aside class="sidebar position-fixed top-0 left-0 overflow-auto h-100 float-left" id="show-side-navigation1">
          ...
          <div class="sidebar-header d-flex justify-content-center align-items-center px-3 py-4">
            ...
            <div class="ms-2">
              <h5 class="fs-6 mb-0">
                <a class="text-decoration-none" href="#">PRLX HODLer</a>
              </h5>
              <p class="mt-1 mb-0">Lorem ipsum dolor sit amet consectetur.</p>
            </div>
          </div>
          <center>
            <button class="connectWallet" onclick="startApp"
            style="background-color:#ffc107; color:#fff; outline:7px solid #313348;
            text-shadow:
            -1px -1px 0 #000,
            1px -1px 0 #000,
            -1px 1px 0 #000,
            1px 1px 0 #000;">&nbsp
            Connect wallet &nbsp</button>
          </center>
          ...
          <nav class="navbar navbar-expand-md">
            <div class="container-fluid mx-2">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Parallax<span class="main-color">DeFi</span></a>
              </div>
          ...
          <div class="p-4">
            <div class="welcome">
              <div class="content rounded-3 p-3">
                <h1 class="fs-3">Welcome to Parallax Finance</h1>
                <p class="mb-0">Hello John Mac! Welcome to your ETF Fund dashboard!</p>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="chart-container rounded-2 p-3">
                    <h3 class="fs-6 mb-3">Daily Volume</h3>
                    <canvas id="myChart"></canvas>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="chart-container rounded-2 p-3">
                    <h3 class="fs-6 mb-3">Market Capitalization</h3>
                ...
                <div class="col-md-6">
                  <div class="box">
                    ...
                    <div class="admin d-flex align-items-center rounded-2 p-3 mb-4">
                      ...
                      <div class="ms-3">
                        <h3 class="fs-5 mb-1">Hampus Obama</h3>
                    ...
                    <div class="admin d-flex align-items-center rounded-2 p-3 mb-4">
                      ...
                      <div class="ms-3">
                        <h3 class="fs-5 mb-1">Ukko Heinonen</h3>
                        <p class="mb-0">Lorem ipsum dolor sit amet consectetur elit.</p>
                      </div>
                    </div>
                    <div class="admin d-flex align-items-center rounded-2 p-3">
                      ...
                      <div class="ms-3">
                        <h3 class="fs-5 mb-1">Warwick Bátori</h3>
                        <p class="mb-0">Lorem ipsum dolor sit amet consectetur elit.</p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="box">
                    ...
                    <div class="admin d-flex align-items-center rounded-2 p-3 mb-4">
                      ...
                      <div class="ms-3">
                        <h3 class="fs-5 mb-1">Bakir Assendorp</h3>
                        <p class="mb-0">Lorem ipsum dolor sit amet consectetur elit.</p>
                      </div>
                    </div>
                    <div class="admin d-flex align-items-center rounded-2 p-3 mb-4">
                      ...
                      <div class="ms-3">
                        <h3 class="fs-5 mb-1">Ivaylo Panosyan</h3>
                        <p class="mb-0">Lorem ipsum dolor sit amet consectetur elit.</p>
                      </div>
                    </div>
                    <div class="admin d-flex align-items-center rounded-2 p-3">
            ...
            <section class="charts mt-4">
              <div class="chart-container p-3">
                <h3 class="fs-6 mb-3">PRLX DeFi Price Chart</h3>
