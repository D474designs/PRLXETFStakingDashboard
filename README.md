...
[**Watch the Video Example on my YouTube Channel**](https://prlx-etf-staking.netlify.app/) [:eye_speech_bubble:](https://prlx-etf-staking.netlify.app/)

[***Make sure to use the MetaMask browser if you are on mobile!***](https://metamask.io/) [:fox_face:](https://metamask.io/)
